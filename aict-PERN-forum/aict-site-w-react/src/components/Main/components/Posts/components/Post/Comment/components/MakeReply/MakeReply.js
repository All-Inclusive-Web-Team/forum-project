...
const MakeReply = ({replyParentID, postFKeyID, parentID, setShowReplyInput, style}) => {
    ...
    return (
        <div className="make-reply-form-container" style={style}>
            <form className='make-reply-form' action="aict-PERN-forum/aict-site-w-react/src/components/Main/components/Posts/components/Post/Comment/components/MakeReply" onSubmit={handleReplyFormSubmit}>
